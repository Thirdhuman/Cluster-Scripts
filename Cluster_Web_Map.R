...
tract_shapes$GEOID= ifelse(
       tract_shapes$GEOID =='02270000100','02158000100',
	ifelse(tract_shapes$GEOID =='04019002701','04019002704',
	ifelse(tract_shapes$GEOID =='04019002903','04019002906',
	ifelse(tract_shapes$GEOID =='04019410501','04019004118',
	ifelse(tract_shapes$GEOID =='04019410502','04019004121',
	ifelse(tract_shapes$GEOID =='04019410503','04019004125',
	ifelse(tract_shapes$GEOID =='04019470400','04019005200',
	ifelse(tract_shapes$GEOID =='04019470500','04019005300',
	ifelse(tract_shapes$GEOID =='06037930401','06037137000',
	ifelse(tract_shapes$GEOID =='36053940101','36053030101',
	ifelse(tract_shapes$GEOID =='36053940102','36053030102',
	ifelse(tract_shapes$GEOID =='36053940103','36053030103',
	ifelse(tract_shapes$GEOID =='36053940200','36053030200',
	ifelse(tract_shapes$GEOID =='36053940300','36053030300',
	ifelse(tract_shapes$GEOID =='36053940401','36053030401',
	ifelse(tract_shapes$GEOID =='36053940403','36053030403',
	ifelse(tract_shapes$GEOID =='36053940600','36053030600',
	ifelse(tract_shapes$GEOID =='36053940700','36053030402',
	ifelse(tract_shapes$GEOID =='36065940000','36065024800',
	ifelse(tract_shapes$GEOID =='36065940100','36065024700',
	ifelse(tract_shapes$GEOID =='36065940200','36065024900',
	ifelse(tract_shapes$GEOID =='36085000900','36085008900',
	ifelse(tract_shapes$GEOID =='46113940500','46102940500',
	ifelse(tract_shapes$GEOID =='46113940800','46102940800',
	ifelse(tract_shapes$GEOID =='46113940900','46102940900',
	ifelse(tract_shapes$GEOID =='51515050100','51019050100',tract_shapes$GEOID))))))))))))))))))))))))))
...
tract_15$Geo_FIPS= ifelse(
       tract_15$Geo_FIPS =='02270000100','02158000100',
	...
	ifelse(tract_15$Geo_FIPS =='36065940200','36065024900',
	ifelse(tract_15$Geo_FIPS =='36085000900','36085008900',
	...
	ifelse(tract_15$Geo_FIPS =='51515050100','51019050100',tract_15$Geo_FIPS))))))))))))))))))))))))))
...
tract_16$Geo_FIPS= ifelse(
       tract_16$Geo_FIPS =='02270000100','02168000100',
	...
	ifelse(tract_16$Geo_FIPS =='36065940200','36065024900',
	ifelse(tract_16$Geo_FIPS =='36085000900','36085008900',
	...
	ifelse(tract_16$Geo_FIPS =='51616050100','51019050100',tract_16$Geo_FIPS))))))))))))))))))))))))))
...
tract_shapes$Native_Tract[is.na(tract_shapes$Native_Tract)] <- 'No'
...
PM_LIC_tracts$Tract_ID= ifelse(
       PM_LIC_tracts$Tract_ID =='02270000100','02158000100',
	...
	ifelse(PM_LIC_tracts$Tract_ID =='36065940200','36065024900',
	ifelse(PM_LIC_tracts$Tract_ID =='36085000900','36085008900',
...
Und_LIC_tracts$Tract_ID= ifelse(
      Und_LIC_tracts$Tract_ID =='02270000100','02158000100',
	...
	ifelse(Und_LIC_tracts$Tract_ID =='36065940200','36065024900',
	ifelse(Und_LIC_tracts$Tract_ID =='36085000900','36085008900',
	...
	ifelse(Und_LIC_tracts$Tract_ID =='51515050100','51019050100',Und_LIC_tracts$Tract_ID))))))))))))))))))))))))))
...
oz_info$GEOID10= ifelse(
      oz_info$GEOID10 =='02270000100','02158000100',
	...
	ifelse(oz_info$GEOID10 =='36065940200','36065024900',
	ifelse(oz_info$GEOID10 =='36085000900','36085008900',
	...
	ifelse(oz_info$GEOID10 =='51515050100','51019050100',oz_info$GEOID10))))))))))))))))))))))))))
...
IDX.dat$FIPS= ifelse(
      IDX.dat$FIPS =='02270000100','02158000100',
	...
	ifelse(IDX.dat$FIPS =='36065940200','36065024900',
	ifelse(IDX.dat$FIPS =='36085000900','36085008900',
